function [ELMout,BiasMatrix_1,BiasMatrix,InputWeight,OutputWeight,Xps,Yps H,M,number_class,label] = MD_OSELMtrain_Start(X,Y,Elm_Type,NumberofHiddenNeurons,ActivationFunction)
%%%%%%%%%%%%% Macro definition
 REGRESSION=0;
 CLASSIFICATION=1;
%% πÈ“ªªØ
